...
function loadSettings() {
    const savedCarbsPerXE = localStorage.getItem("carbsPerXE");
    const savedInsulinPerXE = localStorage.getItem("insulinPerXE");

    if (savedCarbsPerXE) carbsPerXE = parseFloat(savedCarbsPerXE);
    if (savedInsulinPerXE) insulinPerXE = parseFloat(savedInsulinPerXE);
}
